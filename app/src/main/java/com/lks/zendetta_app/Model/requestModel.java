...
public class requestModel {
    public String id, name, date, earlyVisit, endVisit, gambar, status, note;

    public requestModel(String id, String name, String date, String earlyVisit, String endVisit, String gambar, String status) {
        this.id = id;
        this.name = name;
        this.date = date;
